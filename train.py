...
def make_model(tr_features, tr_labels, ts_features, ts_labels, training_epochs, learning_rate):
...
def main():
    ...
    make_model(tr_features, tr_labels, ts_features, ts_labels, args.epochs, args.learning_rate)
